package br.com.academy.apidocs;
...
public class BaseSwaggerConfig {
    ...
    private ApiInfo metaData(){
        return new ApiInfoBuilder().title("Sistema de Gerenciamento de Alunos")
        .description("API Java 11 com Spring Boot 2.6.3 e Frontend com Thymeleaf")
        .version("1.0")
